    ...
    <main>
        ...
        <div class="top-matches-section">
            <div class="top-matches-title" style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;">
                ...
                <div id="paginationControls" style="display:flex;align-items:center;gap:8px;">
        ...
        function renderMatches(){
            ...
            if(!filteredMatches || filteredMatches.length===0){
                if(searchQuery){
                    cont.innerHTML = '<div style="color:#4a5a7b;font-size:0.95rem;">No matches found for "' + searchQuery + '".</div>';
                } else {
            ...
            subset.forEach(m => {
                ...
                // Highlight search term in filename if searching
